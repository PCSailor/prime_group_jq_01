...
and the ‘market price’ of each.

His Start:
Commodities as an object with added properties
...
Also in the user display, should be an ‘average purchased price’, which shows, on average, how much money they have spent on a given fruit in their inventory.
